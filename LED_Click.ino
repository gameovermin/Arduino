...
// 클라이언트가 접속되었는지 확인
  ...
  client.println("<a href=\"/RedLED=ON\"\"><button>Red Turn On</button></a>");
  client.println("<a href=\"/RedLED=OFF\"\"><button>Red Turn Off</button></a>");
    client.println("<br><br>");
  client.println("<a href=\"/BlueLED=ON\"\"><button>Blue Turn On</button></a>");
  client.println("<a href=\"/BlueLED=OFF\"\"><button>Blue Turn Off</button></a>");
  client.println("</html>");
